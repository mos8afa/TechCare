...
def create_blood_request(request):
    ...
    if request.method == 'POST':
        ...
        if not errors:
            ...
            return redirect('doctor:request_offers', request_id=blood_req.id)
...
def request_offers(request, request_id):
    ...
    profile_pic = doctor.profile_pic
    name = "Dr. " + request.user.first_name + " " + request.user.last_name
    return render(request, 'doctor/blood_request_offers.html', {
...
def my_blood_requests_accepted(request):
    ...
    profile_pic = doctor.profile_pic
    name = "Dr. " + request.user.first_name + " " + request.user.last_name
    return render(request, 'doctor/my_blood_requests_accepted.html', {
