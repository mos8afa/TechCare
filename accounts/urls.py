...
urlpatterns = [
    ...
    path("nurse/registration/s2/", views.nurse_registration_s2, name="nurse_registration_s2"),
    path("pharmacist/registration/s2/", views.pharmacist_registration_s2, name="pharmacist_registration_s2"),
