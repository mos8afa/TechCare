...
urlpatterns = [
    ...
    path('nurse/requests/action/<int:request_id>/',       views_2.request_action,          name='nurse_request_action'),
    path('nurse/requests/done/<int:request_id>/',         views_2.mark_nurse_done,         name='mark_done_nurse'),

    path('nurse/slots/',                                  views_2.get_time_slots,          name='nurse_get_time_slots'),
    path('nurse/slots/save/',                             views_2.save_time_slots,         name='nurse_save_time_slots'),
    path('nurse/slots/<int:slot_id>/delete/',             views_2.delete_time_slot,        name='nurse_delete_time_slot'),
