...
class DonorWalletScreen extends StatelessWidget {
  const DonorWalletScreen({super.key});
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
            ...
            child: Icon(Icons.account_balance_wallet_outlined, size: 52, color: _kPrimary.withOpacity(0.4)),
          ),
          const SizedBox(height: 20),
          const Text('Wallet', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: _kDarkText)),
          const SizedBox(height: 8),
          const Text('Wallet coming soon', style: TextStyle(fontSize: 14, color: _kTextGray)),
        ]),
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ..._navItems.map((item) {
                final isActive = item['label'] == 'Wallet';
                return Container(
