...
class DonorComplaintsScreen extends StatelessWidget {
  const DonorComplaintsScreen({super.key});
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
            ...
            child: Icon(Icons.warning_amber_rounded, size: 52, color: _kPrimary.withOpacity(0.4)),
          ),
          const SizedBox(height: 20),
          const Text('Complaints', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: _kDarkText)),
          const SizedBox(height: 8),
          const Text('No complaints filed', style: TextStyle(fontSize: 14, color: _kTextGray)),
        ]),
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ..._navItems.map((item) {
                final isActive = item['label'] == 'Complaints';
                return Container(
