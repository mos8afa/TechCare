...
class DoctorComplaintsScreen extends StatefulWidget {
  const DoctorComplaintsScreen({super.key});

  @override
  State<DoctorComplaintsScreen> createState() =>
      _DoctorComplaintsScreenState();
}

class _DoctorComplaintsScreenState extends State<DoctorComplaintsScreen> {
  ...
  final List<Map<String, dynamic>> _previousComplaints = [
    {
      ...
      'message':
          'A patient cancelled at the last minute without proper notice.',
      'date': 'Apr 2, 2026',
      'status': 'Resolved',
    },
    {
      'subject': 'Payment Delay',
      'message': 'My wallet balance was not updated after a consultation.',
      'date': 'Mar 20, 2026',
      'status': 'Under Review',
    },
  ];
